...
This document defines the novel creation workflow that Claude Code reads and executes directly.
...
#### Purpose
Claude Code automatically creates novels by sequentially calling 13 specialized agents.
...
**Agent**: Main Writer (`.github/agents/main-writer.agent.md` - [English](/.github/agents/main-writer.agent.md#english) | [한국어](/.github/agents/main-writer.agent.md#korean))
...
**Agent**: Story Writer (`.github/agents/story-writer.agent.md` - [English](/.github/agents/story-writer.agent.md#english) | [한국어](/.github/agents/story-writer.agent.md#korean))
**Input**: `concept.md`
**Task**:
```
...
**Agent**: Character Writer (`.github/agents/character-writer.agent.md` - [English](/.github/agents/character-writer.agent.md#english) | [한국어](/.github/agents/character-writer.agent.md#korean))
**Input**: `concept.md`
**Task**:
```
...
**Agent**: Setting Writer (`.github/agents/setting-writer.agent.md` - [English](/.github/agents/setting-writer.agent.md#english) | [한국어](/.github/agents/setting-writer.agent.md#korean))
**Input**: `concept.md`
**Task**:
```
...
**Agent**: Genre Specialist (`.github/agents/genre-specialist.agent.md` - [English](/.github/agents/genre-specialist.agent.md#english) | [한국어](/.github/agents/genre-specialist.agent.md#korean))
**Input**: `concept.md`
**Task**:
```
...
**Agent**: Pacing Manager (`.github/agents/pacing-manager.agent.md` - [English](/.github/agents/pacing-manager.agent.md#english) | [한국어](/.github/agents/pacing-manager.agent.md#korean))
**Input**:
- `final_plan.md`
- `story_structure.md`
...
**Agent**: Dialogue Writer (`.github/agents/dialogue-writer.agent.md` - [English](/.github/agents/dialogue-writer.agent.md#english) | [한국어](/.github/agents/dialogue-writer.agent.md#korean))
...
**Agent**: Action Writer (`.github/agents/action-writer.agent.md` - [English](/.github/agents/action-writer.agent.md#english) | [한국어](/.github/agents/action-writer.agent.md#korean))
...
**Agent**: Emotion Writer (`.github/agents/emotion-writer.agent.md` - [English](/.github/agents/emotion-writer.agent.md#english) | [한국어](/.github/agents/emotion-writer.agent.md#korean))
...
**Agent**: Prose Writer (`.github/agents/prose-writer.agent.md` - [English](/.github/agents/prose-writer.agent.md#english) | [한국어](/.github/agents/prose-writer.agent.md#korean))
...
**Agent**: Editorial Team (`.github/agents/editorial-team.agent.md` - [English](/.github/agents/editorial-team.agent.md#english) | [한국어](/.github/agents/editorial-team.agent.md#korean))
...
```
Hello! Please read WORKFLOW_GUIDE.md.
...
이 문서는 Claude Code가 직접 읽고 실행하는 소설 창작 워크플로우를 정의합니다.
...
#### 목적
Claude Code가 13개의 전문 에이전트를 순차적으로 호출하여 자동으로 소설을 창작합니다.
...
**에이전트**: Main Writer (`.github/agents/main-writer.agent.md` - [English](/.github/agents/main-writer.agent.md#english) | [한국어](/.github/agents/main-writer.agent.md#korean))
**입력**: 사용자의 소설 아이디어
**작업**:
```
사용자 요청을 분석하여:
...
**에이전트**: Story Writer (`.github/agents/story-writer.agent.md` - [English](/.github/agents/story-writer.agent.md#english) | [한국어](/.github/agents/story-writer.agent.md#korean))
**입력**: `concept.md`
**작업**:
```
...
**에이전트**: Character Writer (`.github/agents/character-writer.agent.md` - [English](/.github/agents/character-writer.agent.md#english) | [한국어](/.github/agents/character-writer.agent.md#korean))
**입력**: `concept.md`
**작업**:
```
...
**에이전트**: Setting Writer (`.github/agents/setting-writer.agent.md` - [English](/.github/agents/setting-writer.agent.md#english) | [한국어](/.github/agents/setting-writer.agent.md#korean))
**입력**: `concept.md`
**작업**:
```
...
**에이전트**: Genre Specialist (`.github/agents/genre-specialist.agent.md` - [English](/.github/agents/genre-specialist.agent.md#english) | [한국어](/.github/agents/genre-specialist.agent.md#korean))
**입력**: `concept.md`
**작업**:
```
...
**에이전트**: Pacing Manager (`.github/agents/pacing-manager.agent.md` - [English](/.github/agents/pacing-manager.agent.md#english) | [한국어](/.github/agents/pacing-manager.agent.md#korean))
**입력**:
- `final_plan.md`
- `story_structure.md`
...
**에이전트**: Dialogue Writer (`.github/agents/dialogue-writer.agent.md` - [English](/.github/agents/dialogue-writer.agent.md#english) | [한국어](/.github/agents/dialogue-writer.agent.md#korean))
...
**에이전트**: Action Writer (`.github/agents/action-writer.agent.md` - [English](/.github/agents/action-writer.agent.md#english) | [한국어](/.github/agents/action-writer.agent.md#korean))
**조건**: 액션/전투/추격 장면일 때
**입력**:
- `chapter_0X/outline.md`
- `phase1_planning/setting_world.md`
...
**에이전트**: Emotion Writer (`.github/agents/emotion-writer.agent.md` - [English](/.github/agents/emotion-writer.agent.md#english) | [한국어](/.github/agents/emotion-writer.agent.md#korean))
**조건**: 내면 독백, 감정 폭발, 회상 등
**입력**:
- `chapter_0X/outline.md`
- `phase1_planning/character_profiles.md`
...
**에이전트**: Prose Writer (`.github/agents/prose-writer.agent.md` - [English](/.github/agents/prose-writer.agent.md#english) | [한국어](/.github/agents/prose-writer.agent.md#korean))
...
**에이전트**: Editorial Team (`.github/agents/editorial-team.agent.md` - [English](/.github/agents/editorial-team.agent.md#english) | [한국어](/.github/agents/editorial-team.agent.md#korean))
