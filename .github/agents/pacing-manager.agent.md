...
<serialization-pacing>

## Serialization Pacing (Web Novel)

### Episode Structure
- Hook (5%): Immediate tension or question
- Development (70%): Main content progression
- Cliffhanger (25%): Ending that demands next episode

### Arc Structure
- Arc length: 10-20 episodes per arc
- Escalating stakes across arcs
- Mini-climax every 3-5 episodes
- Major payoff at arc conclusion

### Paywall Conversion Points
- Place major event at episodes 3-5 (free-to-paid transition)
- Ensure consistent quality spike at conversion point
- Reader investment must exceed switching cost by episode 3

### Serialization Rhythm
- Monday hook episodes (strong start to the week)
- Friday cliffhanger episodes (weekend anticipation)
- Balance between plot advancement and character moments
</serialization-pacing>
