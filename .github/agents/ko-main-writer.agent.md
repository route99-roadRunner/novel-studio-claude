...
<agent-delegation>
[Ko-Pacing Manager] 역할 수행: .github/agents/ko-pacing-manager.agent.md 참조
</agent-delegation>

**Phase 2 집필 팀** (장면별 전문화):

<agent-delegation>
[Ko-Dialogue Writer] 역할 수행: .github/agents/ko-dialogue-writer.agent.md 참조
</agent-delegation>

<agent-delegation>
[Ko-Action Writer] 역할 수행: .github/agents/ko-action-writer.agent.md 참조
</agent-delegation>

<agent-delegation>
[Ko-Emotion Writer] 역할 수행: .github/agents/ko-emotion-writer.agent.md 참조
</agent-delegation>

<agent-delegation>
[Ko-Prose Writer] 역할 수행: .github/agents/ko-prose-writer.agent.md 참조
</agent-delegation>
...
<agent-delegation>
[Ko-Research Agent] 역할 수행: .github/agents/ko-research-agent.agent.md 참조
</agent-delegation>
...
- **Changes**: 13개 에이전트 시스템으로 확장 (8->13), Claude Code XML 구조 적용
