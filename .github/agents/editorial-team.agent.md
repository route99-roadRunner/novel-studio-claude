...
- **Parallel execution**: Can run simultaneously with other quality control agents (Feedback Agent, Research Agent)

**Invocation**: Main Writer spawns this agent using:
```
Task tool → subagent_type: "general-purpose"
prompt: "Read .github/agents/editorial-team.agent.md and perform editorial review on [target file]"
```
</spawn-mode>
...
- Point out repetitive expressions and cliches
...
- **Status**: Production Ready — Claude Code Optimized
